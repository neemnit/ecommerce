...
//       {/* Navbar */}
//       <nav
//         className={`fixed top-0 left-0 w-full bg-white text-black p-4 shadow-lg z-50 transition-transform duration-300 ${isNavbarVisible ? "translate-y-0" : "-translate-y-full"
//           }`}
//       >
...
//   {showUserPopup && user && (
//     <div className="absolute right-0 mt-3 w-52 bg-white rounded-lg shadow-xl py-3 z-50 border border-gray-200">
//       {/* Arrow (Triangle) */}
...
//       <div
//         className={`fixed w-full p-4 bg-gray-100 z-40 transition-all duration-300 lg:hidden ${isScrolled ? "top-0 shadow-md" : "top-16"
//           }`}
//       >
...
//       {/* Sidebar Menu */}
//       <div
//         className={`fixed left-0 top-0 w-64 h-full text-black shadow-lg transform ${isOpen ? "translate-x-0" : "-translate-x-full"
