...
const ShowLoginModal: React.FC<ShowLoginModalProps> = ({ handleCloseModal }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-end sm:items-center">
      <div className="bg-white w-full sm:w-96 p-6 rounded-t-lg sm:rounded-lg shadow-lg text-center">
        ...
        <button
          className="flex items-center justify-center w-full bg-white border border-gray-300 text-gray-700 font-medium py-2 px-4 rounded-md shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          onClick={handleLogin}
        >
          <svg
        ...
        <button className="mt-4 text-gray-600 text-sm hover:underline" onClick={handleCloseModal}>
          Cancel
        </button>
      </div>
    </div>
